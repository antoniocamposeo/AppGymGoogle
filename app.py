...
# Dati utente
USER_DATA = {
    "antoniocamposeo99@gmail.com": {
        "password": "123456",
        "credentials_file": "gymtracker-Antonio.json",
        "name": "Antonio"
    },
    "stefano99@gmail.com": {
        "password": "123456",
        "credentials_file": "gymtracker-Stefano.json",
        "name": "Stefano"
    }
}
...
# Se l'utente è loggato, mostra l'applicazione
    ...
    try:
        ...
        if not os.path.isfile(credentials_file):
            st.error(f"File di credenziali '{credentials_file}' non trovato.")
        else:
            # Autorizzazione
